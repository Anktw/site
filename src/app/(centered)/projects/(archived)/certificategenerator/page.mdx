...
I made this project to learn about mongoDB. It is a web application that allows users to generate and download certificates for various courses. The project utilizes Next.js for the frontend and MongoDB for the backend, providing a seamless experience for users to create and manage their certificates.

## Features
### **Certificate Generation**
- Users can create certificates by filling out a form with *number of weeks, start date, course and obviously name*.
<Image link="/images/certificate1.png" alt="Generating Certificates" height="600" width="1000" />
### **Download Certificates**
- After generating a certificate, users can download it in PDF format(This step saves the certificate to the database).
