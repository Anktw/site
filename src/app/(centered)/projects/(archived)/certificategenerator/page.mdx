...
<Image link="/images/projects/certificate/certificate1.png" alt="Generating Certificates" height="600" width="1000" />
### **Download Certificates**
- After generating a certificate, download it in PDF format(This step saves the certificate to the database).
<Image link="/images/projects/certificate/certificate3.png" alt="Downloading Certificates" height="600" width="1000" />
### **Verification**
- Verify the authenticity of the certificates by checking the unique ID associated with each certificate.
<Image link="/images/projects/certificate/certificate2.png" alt="Verifying Certificates" height="600" width="1000" />