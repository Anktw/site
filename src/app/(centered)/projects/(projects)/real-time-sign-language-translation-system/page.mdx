...
endDate: "2026-04"
status: "completed"
tags: ["TensorFlow", "LSTM", "FastAPI", "Streamlit", "Arduino", "Edge AI", "TTS", "Signal Processing"]
stack:
  - label: "Hardware"
    value: "Arduino + Flex Sensors"
  - label: "Model"
    value: "LSTM (TensorFlow)"
...
| Metric | Value |
|--------|-------|
| LSTM inference latency | **25ms** |
| End-to-end response time | **120ms** |
| Prediction stability | Stable under smoothing + confidence filtering |
| Gesture-to-sentence mapping | Custom vocabulary, extensible |
